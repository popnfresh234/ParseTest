...
import com.dmtaiwan.alexander.hours.Login.LoginActivity;
import com.dmtaiwan.alexander.hours.R;
import com.dmtaiwan.alexander.hours.Restaurant.RestaurantActivity;
import com.dmtaiwan.alexander.hours.Restaurant.RestaurantFragment;
import com.dmtaiwan.alexander.hours.Utilities.CustomParseAdapter;
import com.dmtaiwan.alexander.hours.Utilities.ParseConstants;
...
public class ListActivityFragment extends ListFragment implements ListActivityView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (mQueryType) {
            ...
            case FAVORITES:
                mParseAdapter = mPresenter.createAdapter(getActivity(), FAVORITES, null);
                break;

            case MY_RESTAURANTS:
                mParseAdapter = mPresenter.createAdapter(getActivity(), MY_RESTAURANTS, null);
                break;

            case RECENT_RESTAURANTS_ONE_DAY:
                mParseAdapter = mPresenter.createAdapter(getActivity(), RECENT_RESTAURANTS_ONE_DAY, null);
                break;

            case RECENT_RESTAURANTS_ONE_WEEK:
                mParseAdapter = mPresenter.createAdapter(getActivity(), RECENT_RESTAURANTS_ONE_WEEK, null);
                break;

            case RECENT_UPDATE:
                mParseAdapter = mPresenter.createAdapter(getActivity(), RECENT_UPDATE, null);
                break;
